...
A categoria de imposto é o fator mais importante no cálculo do imposto e mudanças nessa categoria (*Steuerklasse*) influenciam bastante na diferença entre o valor bruto e líquido da sua fonte de renda. O site [German Wage Tax Calculator](https://www.brutto-netto-rechner.info/gehalt/gross_net_calculator_germany.php) possui uma descrição (clique no ícone de ajuda ao lado do campo Tax Category) com o requisitos para fazer parte de cada uma das categorias de imposto.
